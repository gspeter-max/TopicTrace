...
def test_rewrite_graph_results_to_canonical_entities_updates_relationship_endpoints():
        ...
        ChunkGraphExtractionResult(
            entities=[
                RawGraphEntity(
                    ...
                    entity_type="Person",
                    chunk_id="doc::0",
                    evidence_text="Mr Musk spoke.",
                )
            ],
            relationships=[
                RawGraphRelationship(
                    source_entity_name="Mr Musk",
                    relationship_type="RELATED_TO",
                    target_entity_name="Tesla",
                    evidence_text="Mr Musk leads Tesla.",
                    chunk_id="doc::0",
                )
            ],
        )
    ...
    rewritten = rewrite_graph_results_to_canonical_entities(
        raw_results, canonical_name_map
    )
        ...
        ChunkGraphExtractionResult(
            entities=[
                RawGraphEntity(
                    ...
                    entity_type="Person",
                    chunk_id="doc::0",
                    evidence_text="Unknown Person spoke.",
                )
            ],
            relationships=[],
        )
        ...
        canonical_entities=[
            {
                ...
                "entity_type": "Person",
                "chunk_id": "doc::0",
                "evidence_text": "Elon spoke",
            }
        ],
        rewritten_relationships=[
            {
                "source_entity_name": "Elon Musk",
                "relationship_type": "RELATED_TO",
                "target_entity_name": "Tesla",
                "evidence_text": "Elon leads Tesla",
                "chunk_id": "doc::0",
            }
        ],
    )
